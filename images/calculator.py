...
button_add6.place(x=40, y=365)
button_add7 = tk.Button(window, text="from 16 to 10ns", fg="white", bg="#DB7093", width=12, height=1, font=("Arial", 20), command=numsys1016)
button_add7.place(x=210, y=365)
